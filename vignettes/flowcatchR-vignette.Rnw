...
fullResults <- kinematics(trajectories(particles3(channel.Frames(MesenteriumSubset,"red"))))
@
...
<<selectRed>>=
plateletsMesenterium <- channel.Frames(MesenteriumSubset,"red")
...
plot.TrajectorySet(trajPlatelets,MesenteriumSubset)
@
