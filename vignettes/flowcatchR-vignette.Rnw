...
# Print elapsed time
elapsed = signif( (proc.time() - ptm)[['elapsed']], 4)
...
for(i in 1:length(trajPlatelets))
{
  ...
  #   ## otherwise, this becomes the value for the field keep in the TrajectoryList with evaluated trajectories
...
hist(allVelocities, breaks=10, probability=T,col = "cadetblue",
     ...
     main="Trajectory Analysis: Curvilinear Velocities Histogram")
