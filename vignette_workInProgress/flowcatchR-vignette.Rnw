...
linkedPlatelets <- link.particles(particlesPlatelets,L=26,R=3,epsilon1=0,epsilon2=0,lambda1=1,lambda2=0,penaltyFunction=penaltyFunctionGenerator(),nframes=20,include.area=FALSE)
...
\flowcatchR incorporates suggestions and feedback from the wet-lab biology units operating at the Center for Thrombosis and Hemostasis (CTH), in particular Sven Jaeckel and Kerstin Jurk. Sven Jaeckel also provided us with the sample acquisition which is available in this vignette.
